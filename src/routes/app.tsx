...
function AppLayout() {
  ...
  useEffect(() => {
    ...
    const confirmSignedOut = async () => {
      // Two checks, a beat apart, before we act on it. A single empty read
      // can still happen on a slow connection or a cold service worker.
      for (const delayMs of [1200, 800]) {
